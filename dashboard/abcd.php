   ...
   <div class="grid-container">
      ...
      <aside id="sidebar">
         ...
         <ul class="sidebar-list">
            ...
            <li class="sidebar-list-item">
               <a href="dashboard.php"><span class="material-icons-outlined">inventory_2 </span> Product
            </li></a>
                  ...
                  <table class="product-display-table">
                     ...
                     <?php while ($row = mysqli_fetch_assoc($select)) { ?>
                        ...
                        <tr>
                           ...
                           <td>
                              <a href="update.php?edit=<?php echo $row['product_id']; ?>" class="box-btn"> <i
                                    class="fas fa-edit"></i> edit </a>
                              <a href="abcd.php?delete=<?php echo $row['product_id']; ?>" class="box-btn"> <i
